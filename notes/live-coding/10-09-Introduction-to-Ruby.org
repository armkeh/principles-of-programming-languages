...
:TODO: [[https://docs.ruby-lang.org/en/2.4.0/syntax/control_expressions_rdoc.html][Control expressions]]

* Dynamic typing, homogenous collections

:TODO:

#+begin_src ruby :results output
a = ["Arrays", :can, "contain", 1, "or more different types"] 
h = {:and => "So can hashes.", :see? => a}
