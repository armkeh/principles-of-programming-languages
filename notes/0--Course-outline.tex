...
\label{sec:org0d50dd4}
At the very least, please review these sections of the outline.
\begin{itemize}
\item \hyperref[sec:org746f459]{Course staff}
\item \hyperref[sec:orgf40a1b5]{Communicating with course staff}
\item \hyperref[sec:org3b74e4c]{Your responsibilities regarding course administration tools}
\item \hyperref[sec:org59610f5]{Asking well-posed questions}
\item \hyperref[sec:orgf0af134]{Grading},
\begin{itemize}
\item \hyperref[sec:orgee90d21]{Missed work},
\item \hyperref[sec:org995676e]{Homework due dates} and
\item \hyperref[sec:orgd5afa78]{Assignment due dates}.
\end{itemize}
\end{itemize}

\section{The purpose of an outline}
\label{sec:orgb86e4eb}
\begin{quote}
...
\label{sec:org746f459}
\subsection{Instructor: Mark Armstrong}
\label{sec:org7fd2894}
\begin{quote}
...
\label{sec:org995676e}
This course will have weekly homeworks, as described in \hyperref[sec:orgf0af134]{Grading}.
...
\label{sec:orgd5afa78}
This course will have three assignments, as described in \hyperref[sec:orgf0af134]{Grading}.
...
Also see \hyperref[sec:orgc7e6657]{Accomodations for SAS and conflicts with other courses};
...
\label{sec:orgb9f6e94}
\subsection{The tools}
\label{sec:orga9e71b2}
...
\end{itemize}
\item Email the course staff member using the email listed under \hyperref[sec:org746f459]{Course staff}.
\begin{itemize}
...
\label{sec:orgece377c}
\subsubsection{\textbf{“SICP”}; “The Wizard Book”}
\label{sec:org3e0113e}
ACM Digital Library citation:
\begin{quote}
