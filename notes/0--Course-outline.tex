...
\label{sec:org5e28210}
At the very least, please review these sections of the outline.
\begin{itemize}
\item \hyperref[sec:orgdaa34a2]{Course staff}
\item \hyperref[sec:org1ccc5a6]{Communicating with course staff}
\item \hyperref[sec:orge88a264]{Your responsibilities regarding course administration tools}
\item \hyperref[sec:orge797bd0]{Asking well-posed questions}
\item \hyperref[sec:org866609c]{Grading},
\begin{itemize}
\item \hyperref[sec:org67317be]{Missed work},
\item \hyperref[sec:orgeb68643]{Homework due dates} and
\item \hyperref[sec:org0d31882]{Assignment due dates}.
\end{itemize}
\end{itemize}

\section{The purpose of an outline}
\label{sec:orge55fdf4}
\begin{quote}
...
\label{sec:orgdaa34a2}
\subsection{Instructor: Mark Armstrong}
\label{sec:org55e3a4f}
\begin{quote}
...
\label{sec:orgeb68643}
This course will have weekly homeworks, as described in \hyperref[sec:org866609c]{Grading}.
...
\label{sec:org0d31882}
This course will have three assignments, as described in \hyperref[sec:org866609c]{Grading}.
...
\end{itemize}
\item Email the course staff member using the email listed under \hyperref[sec:orgdaa34a2]{Course staff}.
\begin{itemize}
...
\label{sec:orga71d2da}
\subsubsection{\textbf{“SICP”}; “The Wizard Book”}
\label{sec:org2c283e0}
ACM Digital Library citation:
\begin{quote}
