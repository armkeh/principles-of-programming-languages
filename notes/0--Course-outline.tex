...
\label{sec:org9b27c2a}
At the very least, please review these sections of the outline.
\begin{itemize}
\item \hyperref[sec:org827468c]{Course staff}
\item \hyperref[sec:org227b493]{Communicating with course staff}
\item \hyperref[sec:org12e6f62]{Your responsibilities regarding course administration tools}
\item \hyperref[sec:org2b1e953]{Asking well-posed questions}
\item \hyperref[sec:orgb6b5308]{Grading},
\begin{itemize}
\item \hyperref[sec:orga8241b0]{Missed work},
\item \hyperref[sec:org6f31b5b]{Homework due dates} and
\item \hyperref[sec:org9dda189]{Assignment due dates}.
\end{itemize}
\end{itemize}

\section{The purpose of an outline}
\label{sec:orgf06a617}
\begin{quote}
...
\label{sec:org827468c}
\subsection{Instructor: Mark Armstrong}
\label{sec:orgc271076}
\begin{quote}
...
\end{itemize}
\item Email the course staff member using the email listed under \hyperref[sec:org827468c]{Course staff}.
\begin{itemize}
...
\label{sec:org2893786}
\subsubsection{\textbf{“SICP”}; “The Wizard Book”}
\label{sec:orgbf6efd7}
ACM Digital Library citation:
\begin{quote}
