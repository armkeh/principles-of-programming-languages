...
\label{sec:org4e648d5}
At the very least, please review these sections of the outline.
\begin{itemize}
\item \hyperref[sec:org2186e73]{Course staff}
\item \hyperref[sec:org9ccf15b]{Communicating with course staff}
\item \hyperref[sec:org63403ac]{Your responsibilities regarding course administration tools}
\item \hyperref[sec:org4d4aa4d]{Asking well-posed questions}
\item \hyperref[sec:org8b73d39]{Grading},
\begin{itemize}
\item \hyperref[sec:orgd1e16d8]{Missed work},
\item \hyperref[sec:org24e274f]{Homework due dates} and
\item \hyperref[sec:orgf210fb2]{Assignment due dates}.
\end{itemize}
\end{itemize}

\section{The purpose of an outline}
\label{sec:org3f723c8}
\begin{quote}
...
\label{sec:org2186e73}
\subsection{Instructor: Mark Armstrong}
\label{sec:org1bf5581}
\begin{quote}
...
\label{sec:org465a267}
:TODO:

\section{Schedule}
\label{sec:org25d6cb0}
\begin{center}
...
\label{sec:org24e274f}
This course will have weekly homeworks, as described in \hyperref[sec:org8b73d39]{Grading}.
...
\label{sec:orgf210fb2}
This course will have three assignments, as described in \hyperref[sec:org8b73d39]{Grading}.

As of the beginning of the course,
the assignments are planned to be due on
\begin{itemize}
\item October 5th,
\item November 9th, and
\item December 14th.
\end{itemize}

Any changes to these dates will be announced on the course homepage.
Also see \hyperref[sec:org1ddd559]{Accomodations for SAS and conflicts with other courses};
...
\label{sec:orgde51266}
\subsection{The tools}
\label{sec:org159e391}
...
\end{itemize}
\item Email the course staff member using the email listed under \hyperref[sec:org2186e73]{Course staff}.
\begin{itemize}
...
\label{sec:org031bff6}
\subsubsection{\textbf{“SICP”}; “The Wizard Book”}
\label{sec:org2b85ce4}
ACM Digital Library citation:
\begin{quote}
...
\label{sec:org3ead6d0}
\subsection{Calendar description}
\label{sec:org6adc51e}
