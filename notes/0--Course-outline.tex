...
\label{sec:org0edf56d}
At the very least, please review these sections of the outline.
\begin{itemize}
\item \hyperref[sec:org53c4022]{Course staff}
\item \hyperref[sec:orge87a8b7]{Communicating with course staff}
\item \hyperref[sec:orgd0d29bc]{Your responsibilities regarding course administration tools}
\item \hyperref[sec:org2db6fa6]{Asking well-posed questions}
\item \hyperref[sec:orgaa6d034]{Grading},
\begin{itemize}
\item \hyperref[sec:org90f4910]{Missed work},
\item \hyperref[sec:org567356d]{Homework due dates} and
\item \hyperref[sec:org4af3a70]{Assignment due dates}.
\end{itemize}
\end{itemize}

\section{The purpose of an outline}
\label{sec:org40f51bc}
\begin{quote}
...
\label{sec:org53c4022}
\subsection{Instructor: Mark Armstrong}
\label{sec:orgd75516c}
\begin{quote}
...
\label{sec:org567356d}
This course will have weekly homeworks, as described in \hyperref[sec:orgaa6d034]{Grading}.
...
\label{sec:org4af3a70}
This course will have three assignments, as described in \hyperref[sec:orgaa6d034]{Grading}.
...
\end{itemize}
\item Email the course staff member using the email listed under \hyperref[sec:org53c4022]{Course staff}.
\begin{itemize}
...
\label{sec:org02c122e}
\subsubsection{\textbf{“SICP”}; “The Wizard Book”}
\label{sec:org100471f}
ACM Digital Library citation:
\begin{quote}
