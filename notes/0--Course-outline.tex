...
\section*{TL;DR}
\label{sec:orga10f8b3}
At the very least, please review these sections of the outline.
\begin{itemize}
\item \hyperref[sec:org7f86eb4]{Course staff}
\item \hyperref[sec:org13d8034]{Your responsibilities regarding course administration tools}
\item \hyperref[sec:org36940b1]{Communicating with course staff}
\end{itemize}

\section*{The purpose of an outline}
\label{sec:orgfc342ba}
\begin{quote}
...
\label{sec:org7f86eb4}
:TODO:

\section*{Schedule}
\label{sec:org4d74002}
\begin{center}
...
\label{sec:orgafdb9f8}
\subsection*{The tools}
\label{sec:org495768d}
...
\end{itemize}
\item Email the course staff member using the email listed under \hyperref[sec:org7f86eb4]{Course staff}.
\begin{itemize}
...
\label{sec:org0125996}
:TODO:

\section*{Grading}
\label{sec:org881d021}
:TODO:

\section*{Approved advisory statements}
\label{sec:orgea40ddf}
