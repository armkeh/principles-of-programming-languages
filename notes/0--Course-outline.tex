...
\label{sec:org768dbe5}
At the very least, please review these sections of the outline.
\begin{itemize}
\item \hyperref[sec:org0e6d17a]{Course staff}
\item \hyperref[sec:org9826a38]{Communicating with course staff}
\item \hyperref[sec:org3d50d18]{Your responsibilities regarding course administration tools}
\item \hyperref[sec:org9e9c1e2]{Asking well-posed questions}
\item \hyperref[sec:org4dd5362]{Grading},
\begin{itemize}
\item \hyperref[sec:orge7d6e72]{Missed work},
\item \hyperref[sec:org8254d24]{Homework due dates} and
\item \hyperref[sec:orge1190dd]{Assignment due dates}.
\end{itemize}
\end{itemize}

\section{The purpose of an outline}
\label{sec:org85da7e6}
\begin{quote}
...
\label{sec:org0e6d17a}
\subsection{Instructor: Mark Armstrong}
\label{sec:orgdb14ac7}
\begin{quote}
...
\label{sec:org8254d24}
This course will have weekly homeworks, as described in \hyperref[sec:org4dd5362]{Grading}.
...
\label{sec:orge1190dd}
This course will have three assignments, as described in \hyperref[sec:org4dd5362]{Grading}.
...
Also see \hyperref[sec:org947c903]{Accomodations for SAS and conflicts with other courses};
...
\label{sec:orge2ca198}
\subsection{The tools}
\label{sec:orgb4cb03c}
...
\end{itemize}
\item Email the course staff member using the email listed under \hyperref[sec:org0e6d17a]{Course staff}.
\begin{itemize}
