...
\section*{Boilerplate}
\label{sec:orgea8ed27}
\subsection*{Submission procedures}
\label{sec:org1e9e294}
\subsubsection*{Submission method}
\label{sec:org4cba52b}
...
\label{sec:org3b24eca}
\subsubsection*{Individual work}
\label{sec:org50d48ab}
