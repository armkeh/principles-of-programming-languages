...
\section*{Boilerplate}
\label{sec:org1c20479}
\subsection*{Submission procedures}
\label{sec:org86450a5}
\subsubsection*{Submission method}
\label{sec:org6379079}
...
\label{sec:orge6c1beb}
\subsubsection*{Individual work}
\label{sec:org674d5d2}
...
Also see \hyperref[sec:org10deaf6]{More \texttt{LeafTree} and \texttt{BinTree} examples}.

\section*{Part 2: Flattening trees to lists          [20 points]}
\label{sec:org7c1208f}
