...
\section*{Boilerplate}
\label{sec:orgaa4deb4}
\subsection*{Submission procedures}
\label{sec:orgcb24eb3}
\subsubsection*{Submission method}
\label{sec:org82febce}
...
\label{sec:org7448991}
\subsubsection*{Individual work}
\label{sec:org359f63b}
...
Also see \hyperref[sec:org7d67001]{More \texttt{LeafTree} and \texttt{BinTree} examples}.

\section*{Part 2: Flattening trees to lists          [20 points]}
\label{sec:orgbea4b8d}
...
\section*{Testing}
\label{sec:org139bfa8}
\subsection*{Instructions}
\label{sec:org51c9f6e}
