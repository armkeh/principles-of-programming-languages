...
\section*{Boilerplate}
\label{sec:orgeb8d5d5}
\subsection*{Submission procedures}
\label{sec:org526d716}
\subsubsection*{Submission method}
\label{sec:org2220362}
...
\label{sec:org7a6f120}
\subsubsection*{Individual work}
\label{sec:org5907ec7}
...
Also see \hyperref[sec:orga02937c]{More \texttt{LeafTree} and \texttt{BinTree} examples}.

\section*{Part 2: Flattening trees to lists          [20 points]}
\label{sec:org443fa8c}
...
\section*{Testing}
\label{sec:orge8b3cd6}
\subsection*{Instructions}
\label{sec:orgca76e14}
