...
(def compare-ten-ten
   '((GuardedCommand. '(>= 10 10) :gte)
     (GuardedCommand. '(=  10 10) :eq)
     (GuardedCommand. '(<= 10 10) :lte)))

(def compare-ten-five
   '((GuardedCommand. '(>= 10 5) :gte)
     (GuardedCommand. '(=  10 5) :eq)
     (GuardedCommand. '(<= 10 5) :lte)))

(def compare-five-ten
   '((GuardedCommand. '(>= 5 10) :gte)
     (GuardedCommand. '(=  5 10) :eq)
     (GuardedCommand. '(<= 5 10) :lte)))

(deftest allowed-commands-tests
