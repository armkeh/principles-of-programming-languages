...
\section*{Boilerplate}
\label{sec:org6997ffc}
\subsection*{Submission procedures}
\label{sec:orgbc092ac}
\subsubsection*{Submission method}
\label{sec:org1181ecf}
...
\label{sec:orga62adb6}
\subsubsection*{Individual work}
\label{sec:org1ddaec4}
