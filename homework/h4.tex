...
\label{sec:org4725703}
\subsection*{Preamble}
\label{sec:org0da48af}
...
\label{sec:org5bc4d20}
\subsubsection*{Individual work}
\label{sec:org7937c2b}
...
\label{sec:orgdcc11bd}
Using the custom \texttt{Stream} type for this assignment,
defined in “\hyperref[sec:org219c651]{a type for this assignment}” above,
