...
- [[./testing/a1/a1p3.plt][a1p2.plt]]
- [[./testing/a1/a1p4.plt][a1p2.plt]]
...
[[./testing/a1/setup.sh][setup.sh]]
#+begin_src shell :tangle ./testing/a1/setup.sh :shebang t
docker-compose build --force-rm
#+end_src

[[./testing/a1/run.sh][run.sh]]
#+begin_src shell :tangle ./testing/a1/run.sh :shebang t
# Run the container
