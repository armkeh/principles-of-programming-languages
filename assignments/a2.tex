...
\label{sec:orga5676cf}
\subsection*{November 15th}
\label{sec:orgc402286}
\begin{itemize}
...
\section*{Boilerplate}
\label{sec:org1d70a3e}
\subsection*{Documentation}
\label{sec:org165737c}
...
because \texttt{typecheck((λ x : nat → x)(zero))} should return \texttt{nat}.
...
\label{sec:org3d9d3cc}
\subsubsection*{Scala}
\label{sec:orgcf8b986}
